...
carMarket.getAgencyByName2 = function (marketObj, name) {
...
carMarket.getAgencyByName3 = function (sellers, name) {
  return sellers.filter((seller) => seller.agencyName === name);
};

// console.log(carMarket.getAgencyByName(carMarket.sellers, "Best Deal"));
// console.log(carMarket.getAgencyByName2(carMarket, "Best Deal")); //!return undefined if not fined
// console.log(carMarket.getAgencyByName3(carMarket.sellers, "Best Deal"));
...
carMarket.getAgencyIdByName2 = function (marketObj, name) {
  const agency = marketObj.sellers.find((agency) => {
...
// console.log(carMarket.getAgencyIdByName2(carMarket, "Best Deal"));
...
// console.log(carMarket.getCustomerByName(carMarket.customers, "Lilah Geula"));
//!-----------------------------------------------------------------------------------------------
